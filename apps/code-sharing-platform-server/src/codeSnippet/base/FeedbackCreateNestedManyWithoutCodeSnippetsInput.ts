...
@InputType()
class FeedbackCreateNestedManyWithoutCodeSnippetsInput {
...
export { FeedbackCreateNestedManyWithoutCodeSnippetsInput as FeedbackCreateNestedManyWithoutCodeSnippetsInput };
